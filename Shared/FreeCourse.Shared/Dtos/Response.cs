...
namespace FreeCourse.Shared.Dtos
{
    public class Response<T>
    {
        ...
        {
            return new Response<T> { Data = data, StatusCode = statusCode, IsSuccessful = true, Errors = default };
        }

        public static Response<T> Success(int statusCode)
        {
            return new Response<T> { Data = default(T), StatusCode = statusCode, IsSuccessful = true, Errors = default };
        }
