...
namespace FreeCourse.Shared.Dtos
{
    public class ResponseDto<T>
    {
        ...
        {
            return new ResponseDto<T> { Data = data, StatusCode = statusCode, IsSuccessful = true, Errors = default };
        }

        public static ResponseDto<T> Success(int statusCode)
        {
            return new ResponseDto<T> { Data = default(T), StatusCode = statusCode, IsSuccessful = true, Errors = default };
        }
